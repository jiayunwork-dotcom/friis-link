// Command friis-link is a free-space link budget calculator.
//
// It reads a radio scenario from a JSON file, applies the Friis
// transmission equation and (when the noise section is present) the
// kTBF noise floor, then prints wavelength, free-space path loss,
// received power, SNR, fading margin and the pass/fail verdict. The
// reverse subcommand answers the inverse questions (coverage range and
// required EIRP).
package main
