...
// JSONReport is the machine-readable shape of a budget result. Optional
// fields use pointers so JSON output omits them when the noise section
// was absent.
...
// ToJSON serialises the result for the -json CLI flag.
